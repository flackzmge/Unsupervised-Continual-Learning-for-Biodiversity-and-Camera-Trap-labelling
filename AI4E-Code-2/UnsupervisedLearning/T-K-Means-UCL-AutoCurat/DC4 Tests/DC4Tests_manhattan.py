...
def manhattan_distance(x, centroid):
    # Compute the difference, following by raising to power 2 and summing
    dist = ((x - centroid)).sum(axis = x.ndim - 1)
...
def get_closest_centroid(x, centroids):
    ...
    dist = manhattan_distance(x, centroids)
...
def compute_sse(data, centroids, assigned_centroids):
    ...
    # Compute SSE
    sse = manhattan_distance(data, centroids[assigned_centroids]).sum() / len(data)
...
#source_paths.append('/home/tomasmaul/Downloads/AI4E-Wrap-Up/AI4E-Code/Data-c/Tree-Ant-Data-2-c/SourcePicsOlympus-c/')
...
#target_paths.append('/home/tomasmaul/Downloads/AI4E-Wrap-Up/AI4E-Code/Data-c/Tree-Ant-Data-2-c/TargetPics')
...
#boundaries_path_files.append('/home/tomasmaul/Downloads/AI4E-Wrap-Up/AI4E-Code/Data-c/Tree-Ant-Data-2-c/Boundaries.txt')
